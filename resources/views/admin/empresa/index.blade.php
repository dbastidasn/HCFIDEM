    ...
    <div class="card card-warning">
        <div class="card-header with-border">
          ...
          <div class="card-tools pull-right">
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-u"><i class="fa fa-fw fa-plus-circle"></i> Nueva Empresa</button>
            </button>
          </div>
        </div>
    ...
    <div class="modal fade" tabindex="-1" id ="modal-u" role="dialog" aria-labelledby="myLargeModalLabel">
        ...
        <div class="row">
            <div class="col-lg-12">
              ...
              <form action="{{route('guardar_empresa')}}" id="form-general" class="form-horizontal" method="POST">
                @csrf
                <div class="card-body">
                              ...
                              <div class="card-footer">
                                  ...
                                  <div class="col-lg-6">
                                  @include('includes.boton-form-crear-empresa')    
                              </div>
                               </div>
                              <!-- /.card-footer -->
              </form>
