...
<li class="dd-item dd3-item" data-id="{{$item["id"]}}">
    ...
    <div class="dd3-content {{$item["url"] == "javascript:;" ? "font-weight-bold" : ""}}">
        ...
        <a href="{{route('eliminar_menu', ['id'=>$item["id"]])}}" class="eliminar-menu pull-right eliminar tooltipsC" title="Eliminar este menú"><i class="fa fa-fw fa-trash text-danger"></i></a>
    </div>
</li>
@else
<li class="dd-item dd3-item" data-id="{{$item["id"]}}">
